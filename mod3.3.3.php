...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 6sixth WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 6sixth WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['phdScholarName']); ?></td>
                        <td><?php echo htmlspecialchars($data['department']); ?></td>
                        <td><?php echo htmlspecialchars($data['guideName']); ?></td>
                        <td><?php echo htmlspecialchars($data['thesisTitle']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfRegistration']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfPhdAward']); ?></td>
