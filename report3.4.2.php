...
<body>
        ...
        <div class="rep-container">
            ...
            <div class="filter-container">
                ...
                <select class="filter-button" id="deptFilter">
                    ...
                    $deptResult = mysqli_query($conn, "SELECT DISTINCT awardName FROM 9nine");
                    while ($deptRow = mysqli_fetch_assoc($deptResult)) {
                        echo "<option value='{$deptRow['awardName']}'>" . htmlspecialchars($deptRow['awardName']) . "</option>";
                    }
                    ?>
                </select>
            </div>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            /* Save to file */
            XLSX.writeFile(wb, '3.4.2.report.xlsx');
        }
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                ...
                $sql = "SELECT COUNT(*) as count FROM 9nine WHERE yearOfAward = '$i'";
