    ...
    <div class="graph-container">
        <div class="rep-container">
            ...
            <div class="filter-container box">
                ...
                <select class="filter-button" id="deptFilter">
                    ...
                    $deptResult = mysqli_query($conn, "SELECT DISTINCT teacherDepartment FROM 7seventh");
                    while ($deptRow = mysqli_fetch_assoc($deptResult)) {
                        echo "<option value='{$deptRow['teacherDepartment']}'>" . htmlspecialchars($deptRow['teacherDepartment']) . "</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>{$row['titleOfPaper']}</td>";
                        echo "<td>{$row['authorName']}</td>";
                        echo "<td>{$row['teacherDepartment']}</td>";
        ...
        <script>
            ...
            function exportToExcel() {
                ...
                /* Save to file */
                XLSX.writeFile(wb, '3.3.4.report.xlsx');
            }
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                    ...
                    $sql = "SELECT COUNT(*) as count FROM 7seventh WHERE yearOfPublication = '$i'";
