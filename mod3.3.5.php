...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 8eight WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 8eight WHERE username = ?";
    ...
    <div class="container">
        ...
        <table class="table">
            <thead>
                <tr>
                    <th>slNo</th>
                    <th>First Name of the Teacher</th>
                    <th>Last Name of the Teacher</th>
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['slNo']); ?></td>
                        <td><?php echo htmlspecialchars($data['firstName']); ?></td>
                        <td><?php echo htmlspecialchars($data['lastName']); ?></td>
                        <td><?php echo htmlspecialchars($data['bookTitle']); ?></td>
                        <td><?php echo htmlspecialchars($data['paperTitle']); ?></td>
                        <td><?php echo htmlspecialchars($data['proceedingsTitle']); ?></td>
                        <td><?php echo htmlspecialchars($data['conferenceName']); ?></td>
                        <td><?php echo htmlspecialchars($data['nationalOrInternational']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfPublication']); ?></td>
                        <td><?php echo htmlspecialchars($data['issnNumber']); ?></td>
                        <td><?php echo htmlspecialchars($data['affiliatingInstitute']); ?></td>
                        <td><?php echo htmlspecialchars($data['publisherName']); ?></td>
