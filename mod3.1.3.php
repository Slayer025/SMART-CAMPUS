...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 2second WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 2second WHERE username = ?";
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($data['researchProject']); ?></td>
                        <td><?php echo htmlspecialchars($data['amountReceived']); ?></td>
                        <td><?php echo htmlspecialchars($data['fundingAgency']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfSanction']); ?></td>
