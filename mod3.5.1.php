...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 93twelve WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 93twelve WHERE username = ?";
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($data['linkageTitle']); ?></td>
                        <td><?php echo htmlspecialchars($data['partneringInstitution']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfCommencement']); ?></td>
                        <td><?php echo htmlspecialchars($data['durationFrom']); ?></td>
                        <td><?php echo htmlspecialchars($data['durationTo']); ?></td>
                        <td><?php echo htmlspecialchars($data['natureOfLinkage']); ?></td>
