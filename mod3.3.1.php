...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 4fourth WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 4fourth WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['codeOfEthicsURL']); ?></td>
                        <td><?php echo htmlspecialchars($data['accessToPlagiarismSoftware']); ?></td>
                        <td><?php echo htmlspecialchars($data['mechanismForPlagiarism']); ?></td>
