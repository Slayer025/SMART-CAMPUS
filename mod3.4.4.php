...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 92eleven WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 92eleven WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['activityName']); ?></td>
                        <td><?php echo htmlspecialchars($data['organizingUnit']); ?></td>
                        <td><?php echo htmlspecialchars($data['schemeName']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfActivity']); ?></td>
