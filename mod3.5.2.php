...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 94thirteen WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 94thirteen WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['organizationWithMoU']); ?></td>
                        <td><?php echo htmlspecialchars($data['institutionName']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfSigning']); ?></td>
                        <td><?php echo htmlspecialchars($data['mouDurationStart']); ?></td>
                        <td><?php echo htmlspecialchars($data['mouDurationEnd']); ?></td>
                        <td><?php echo htmlspecialchars($data['activities']); ?></td>
                        <td><?php echo htmlspecialchars($data['studentsParticipated']); ?></td>
                        <td><?php echo htmlspecialchars($data['teachersParticipated']); ?></td>
                        <td>
