    ...
    <div class="graph-container">
            ...
            <div class="filter-container">
                ...
                <select class="filter-button" id="yearFilter">
                    ...
                    <select class="filter-button" id="deptFilter">
                        <option class="button" value="">Activity Names</option>
                        <?php
                        // Generate department options
                        $deptResult = mysqli_query($conn, "SELECT DISTINCT activityName FROM 91ten");
                        while ($deptRow = mysqli_fetch_assoc($deptResult)) {
                            echo "<option value='{$deptRow['activityName']}'>" . htmlspecialchars($deptRow['activityName']) . "</option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>{$row['organizingUnit']}</td>";
                            echo "<td>{$row['yearOfActivity']}</td>";
        ...
        <script>
            ...
            function exportToExcel() {
                ...
                /* Save to file */
                XLSX.writeFile(wb, '3.4.3.report.xlsx');
            }
            ...
            function filterData() {
                ...
                tableRows.forEach(function (row) {
                    ...
                    var dept = row.cells[0].innerText;
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                    ...
                    $sql = "SELECT COUNT(*) as count FROM 91ten WHERE yearOfActivity = '$i'";
