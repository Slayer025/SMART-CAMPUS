    ...
    <div class="graph-container">
        ...
        <script>
            ...
            for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                ...
                $sql = "SELECT COUNT(*) as count FROM 1first WHERE yearOfAward = '$i'";
            ...
            function exportToExcel() {
                ...
                /* Save to file */
                XLSX.writeFile(wb, '3.1.1.report.xlsx');
            }
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Close modal when mouse leaves the modal region
