...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 5fifth WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 5fifth WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['awardeeName']); ?></td>
                        <td><?php echo htmlspecialchars($data['contactDetails']); ?></td>
                        <td><?php echo htmlspecialchars($data['awardName']); ?></td>
                        <td><?php echo htmlspecialchars($data['awardingAgency']); ?></td>
                        <td><?php echo htmlspecialchars($data['yearOfAward']); ?></td>
                        <td><?php echo htmlspecialchars($data['incentiveDetails']); ?></td>
