...
if (isset($_POST["delete"])) {
    ...
    $sqlDelete = "DELETE FROM 7seventh WHERE username = ? AND id = ?";
...
$sql = "SELECT * FROM 7seventh WHERE username = ?";
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($userData as $data): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($data['titleOfPaper']); ?></td>
                        <td><?php echo htmlspecialchars($data['authorName']); ?></td>
                        <td><?php echo htmlspecialchars($data['teacherDepartment']); ?></td>
                        <td><?php echo htmlspecialchars($data['journalName']); ?></td>
