...
<body>
        ...
        <div class="rep-container">
            ...
            <div class="filter-container box">
                ...
                <select class="filter-button" id="deptFilter">
                    <option class="button" value="">National & International</option>
                    <?php
                    // Generate department options
                    $deptResult = mysqli_query($conn, "SELECT DISTINCT nationalOrInternational FROM 8eight");
                    while ($deptRow = mysqli_fetch_assoc($deptResult)) {
                        echo "<option value='{$deptRow['nationalOrInternational']}'>" . htmlspecialchars($deptRow['nationalOrInternational']) . "</option>";
                    }
                    ?>
                </select>
            </div>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            /* Save to file */
            XLSX.writeFile(wb, '3.3.5.report.xlsx');
        }
        ...
        function filterData() {
            ...
            tableRows.forEach(function (row) {
                var year = row.cells[8].innerText;
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                ...
                $sql = "SELECT COUNT(*) as count FROM 8eight WHERE yearOfPublication = '$i'";
