...
// Fetch data from the database for the "92eleven" table
$sql = "SELECT * FROM 92eleven";
    ...
    <div class="graph-container">
            ...
            <div class="filter-container">
                ...
                <select class="filter-button" id="deptFilter">
                    <option class="button" value="">All Departments</option>
                        ...
                        $deptResult = mysqli_query($conn, "SELECT DISTINCT schemeName FROM 92eleven");
                        while ($deptRow = mysqli_fetch_assoc($deptResult)) {
                            echo "<option value='{$deptRow['schemeName']}'>" . htmlspecialchars($deptRow['schemeName']) . "</option>";
                        }
                        ?>
                    </select>
                </div>
        ...
        <script>
            ...
            function exportToExcel() {
                ...
                /* Save to file */
                XLSX.writeFile(wb, '3.4.4.report.xlsx');
            }
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                for ($i = $currentYear; $i > $currentYear - 5; $i--) {
                    ...
                    $sql = "SELECT COUNT(*) as count FROM 92eleven WHERE yearOfActivity = '$i'";
